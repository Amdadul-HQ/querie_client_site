...
const Footer = () => {
    ...
    <div className="container p-6 mx-auto">
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">qurie01@email.com</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <p className="text-center text-gray-500 dark:text-gray-400">© QURIE 2024 - All rights reserved</p>
        </div>
    </div>
</footer>
    );
